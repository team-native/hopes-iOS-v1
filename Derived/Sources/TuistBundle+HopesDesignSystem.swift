...
/// Since HopesDesignSystem is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "HopesDesignSystem_HopesDesignSystem"
        ...
        fatalError("unable to find bundle named HopesDesignSystem_HopesDesignSystem")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class HopesDesignSystemResources: NSObject {
